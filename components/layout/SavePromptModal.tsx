...
export function SavePromptModal() {
  ...
  const dialogTitleId = 'save-prompt-modal-title'
  const dialogDescriptionId = 'save-prompt-modal-description'
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <h2 id={dialogTitleId} className="text-[16px] font-semibold text-text-base">
            Save your work permanently
          </h2>
          <p id={dialogDescriptionId} className="mt-2 text-[13px] leading-relaxed text-text-muted">
        ...
        <div className="mt-6 flex flex-col gap-3">
          <button
            ...
            className="flex h-10 w-full items-center justify-center rounded-full bg-[var(--primary)] text-[14px] font-medium text-white transition-all hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-text-brand"
          >
            Create Free Account
          </button>
          <button
            ...
            className="flex h-10 w-full items-center justify-center rounded-full border border-[var(--surface-divider)] text-[13px] font-medium text-text-muted transition-all hover:bg-[var(--surface-overlay)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-text-brand"
          >
            Continue as Guest
          </button>
        </div>
