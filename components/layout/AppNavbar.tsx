...
export function AppNavbar({
  ...
  const authInputClassName =
    'h-9 w-full rounded-[6px] border border-[#ebebeb] bg-white pl-3 pr-3 py-1 text-[13px] leading-5 text-[#333333] shadow-[0_1px_2px_0_rgba(0,0,0,0.05)] focus-visible:border-[var(--primary,#7962f4)] focus-visible:outline-none focus-visible:ring-0 focus-visible:ring-offset-0'
  const authTextareaClassName =
    'w-full rounded-[6px] border border-[#ebebeb] bg-white pl-3 pr-3 py-2 text-[13px] leading-5 text-[#333333] shadow-[0_1px_2px_0_rgba(0,0,0,0.05)] focus-visible:border-[var(--primary,#7962f4)] focus-visible:outline-none focus-visible:ring-0 focus-visible:ring-offset-0'
        ...
        {showThemeButton && (
          <div ref={themeMenuRef} className="relative">
            ...
            <div
              ...
              className={`absolute right-0 top-[48px] z-50 overflow-hidden rounded-[18px] border border-[#e2e2e2] bg-white p-4 shadow-[0_4px_6px_-1px_rgba(0,0,0,0.1),0_2px_4px_-1px_rgba(0,0,0,0.06)] transition-all duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] ${
                isThemeMenuOpen
                  ? 'pointer-events-auto h-auto w-[364px] opacity-100 translate-y-0'
                  : 'pointer-events-none h-0 w-[220px] opacity-0 -translate-y-2 p-0'
              }`}
            >
              <div className="flex h-full flex-col gap-4 text-[#1a163d]">
                <div className="flex items-center justify-between rounded-[8px] bg-[#f3e8ff] px-2 py-2">
                  <span className="text-[14px] font-medium leading-none text-[var(--tertairy,#251f7b)]">Theme</span>
                ...
                <div className="grid flex-1 grid-cols-2 gap-4">
                  <button
                    ...
                    className={`overflow-hidden rounded-[18px] border bg-white text-left transition-all duration-200 ${
                      selectedTheme === 'dark'
                        ? 'border-[#1f275f]'
                  ...
                  >
                    ...
                    <div className="bg-white px-4 py-4 text-[14px] font-semibold leading-none text-[#1a163d]">
                      Dark
                    </div>
                  </button>
          ...
          <div ref={profileMenuRef} className="relative">
            <button
              ...
              className={`flex h-8 w-8 items-center justify-center rounded-[8px] bg-[var(--primary,#7962f4)] text-white ${
                showProfileActiveBorder && isProfileMenuOpen
                  ? 'border border-[var(--tertairy,#251f7b)]'
            ...
            {showProfileDropdown && (
              <div
                ...
                className={`absolute right-0 top-[48px] z-50 overflow-hidden rounded-[10px] border border-[#e2e2e2] bg-white p-4 shadow-[0_4px_6px_-1px_rgba(0,0,0,0.1),0_2px_4px_-1px_rgba(0,0,0,0.06)] transition-all duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] ${
                  isProfileMenuOpen
              ...
              >
                {profileView === 'details' ? (
                  <div className="flex h-full min-h-0 flex-col gap-3 text-[var(--tertairy,#251f7b)]">
                    <div className="flex h-8 items-center justify-between rounded-[8px] bg-[#f3e8ff] px-2">
                      <span className="text-[14px] font-medium leading-none">Profile</span>
                      <button
                        type="button"
                        onClick={() => setProfileView('menu')}
                        aria-label="Close profile details"
                        className="inline-flex h-4 w-4 items-center justify-center text-[var(--tertairy,#251f7b)]"
                      >
                    ...
                    <div className="flex items-center gap-3">
                      <div className="relative h-[73px] w-[73px] shrink-0">
                        {profilePhoto ? (
                          ...
                          <div className="flex h-[73px] w-[73px] items-center justify-center rounded-full bg-[var(--primary,#7962f4)] text-[26px] font-semibold text-white">
                            {profileInitial}
                          </div>
                        )}
                        ...
                        <label
                          ...
                          className="absolute right-0 top-0 inline-flex h-6 w-6 cursor-pointer items-center justify-center rounded-full bg-[#f3e8ff] text-[var(--tertairy,#251f7b)] shadow-[0_1px_2px_rgba(0,0,0,0.1)]"
                        >
                          <EditBold size={14} />
                        </label>
                        ...
                        <button
                          ...
                          className="absolute bottom-0 right-0 inline-flex h-6 w-6 items-center justify-center rounded-full bg-white text-[#d14343] shadow-[0_1px_2px_rgba(0,0,0,0.12)]"
                        >
                          <TrashBold size={14} />
                        </button>
                      </div>
                      ...
                      <div className="flex flex-col gap-2">
                        <span className="text-[12px] font-medium leading-none text-[var(--tertairy,#251f7b)]">
                          Profile photo
                        </span>
                        <span className="text-[12px] leading-none text-[#7f7f7f]">
                    ...
                    <form onSubmit={handleProfileSubmit} className="flex min-h-0 flex-1 flex-col gap-3 overflow-hidden">
                      <div className="grid min-h-0 flex-1 gap-3 overflow-y-auto pr-1 theme-scrollbar">
                        <div>
                          <label className="mb-1 block text-[12px] font-medium leading-none text-[#333333]">
                            Full Name
                          </label>
                          <input
                            name="full_name"
                        ...
                        <div>
                          ...
                          <input
                            ...
                            disabled
                            className={`${authInputClassName} cursor-not-allowed bg-[#f8f8f8] text-[#7f7f7f]`}
                          />
                        </div>
                      ...
                      <div className="mt-auto flex items-center justify-end gap-2">
                        <button
                          ...
                          className="inline-flex h-8 items-center justify-center rounded-[8px] bg-[var(--primary,#7962f4)] px-3 text-[12px] font-medium text-white disabled:opacity-60"
                        >
                  ...
                  <div className="flex h-full flex-col gap-[10px] text-[var(--tertairy,#251f7b)]">
                    <button
                      type="button"
                      onClick={() => setProfileView('details')}
                      className="flex h-8 w-full items-center gap-1 rounded-[8px] px-2 text-left transition-colors duration-200 hover:bg-[#f3e8ff]"
                    >
                      <UserBold size={16} />
                      <span className="text-[14px] font-medium leading-none">Profile</span>
                    </button>
